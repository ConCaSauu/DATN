...
(function ($) {
    ...
    $("select").each(function () {
        if ($(this).attr('id') === 'select-city') {
            return; // Nếu đúng, bỏ qua thẻ này
        }
    ...
    document.getElementById('editButton').addEventListener('click', function() {
        ...
        inputs.forEach(input => {
            input.disabled = !input.disabled; // Bật hoặc tắt chế độ chỉnh sửa
        });
        ...
        // } else {
        //     // Gửi dữ liệu tới server Laravel
        //     const formData = {
        ...
        //     fetch('user/save', { // Sử dụng route Laravel
        //         method: 'POST',
        //         headers: {
